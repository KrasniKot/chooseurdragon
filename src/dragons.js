...
export const drgns = [
    ...
    new Drgn('Cremallerus Espantosus', 'Misterio', ),
    new Drgn('Cuernatronante', 'Rastreadora'),
    new Drgn('Destripador Carmesí', 'Piedra'),
    new Drgn('Destroza Cavernas', 'Misterio'),
    new Drgn('Dramillón', 'Misterio'),
    new Drgn('Eructcálido', 'Piedra'),
    new Drgn('Erupciodón', 'Piedra'),
    new Drgn('Espectro de Nieve', 'Embestida'),
    new Drgn('Extinguehumo', 'Misterio'),
    new Drgn('Furia Nocturna', 'Embestida'),
    new Drgn('Furia Luminosa', 'Embestida'),
    new Drgn('Garra Mortal', 'Embestida'),
    new Drgn('Garratrueno', 'Rastreadora'),
